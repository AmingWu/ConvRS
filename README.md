...
We used tensorflow 1.0.0, python 2.7 and CUDA 8.0. Before using this code, you should download MSVD dataset from this link, i.e.,  http://www.cs.utexas.edu/users/ml/clamp/videoDescription/.
